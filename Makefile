...
sample1: sample1.o display.o shader.o mesh.o texture.o stb_image.o obj_loader.o
	$(CC) $(CPPFLAGS) -o $(BUILD)/sample1 $(OBJ)/obj_loader.o $(OBJ)/mesh.o $(OBJ)/shader.o $(OBJ)/display.o $(OBJ)/stb_image.o $(OBJ)/texture.o $(OBJ)/sample1.o $(OPENGL)

sample1.o: samples/sample1.cpp
	$(CC) $(CPPFLAGS) -c samples/sample1.cpp -o $(OBJ)/sample1.o $(OPENGL) -Isrc

obj_loader.o: $(SRC)/obj_loader.cpp
	$(CC) $(CFLAGS) -c $(SRC)/obj_loader.cpp -o $(OBJ)/obj_loader.o $(OPENGL)
